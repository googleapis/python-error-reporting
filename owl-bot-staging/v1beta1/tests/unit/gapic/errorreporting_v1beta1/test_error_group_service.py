...
def test_get_group_rest_required_fields(request_type=error_group_service.GetGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_group._get_unset_required_fields(jsonified_request)
...
def test_get_group_rest_unset_required_fields():
    transport = transports.ErrorGroupServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_update_group_rest_required_fields(request_type=error_group_service.UpdateGroupRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_group._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
