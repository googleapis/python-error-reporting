...
def test_report_error_event_rest_required_fields(request_type=report_errors_service.ReportErrorEventRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).report_error_event._get_unset_required_fields(jsonified_request)
...
def test_report_error_event_rest_unset_required_fields():
    transport = transports.ReportErrorsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
