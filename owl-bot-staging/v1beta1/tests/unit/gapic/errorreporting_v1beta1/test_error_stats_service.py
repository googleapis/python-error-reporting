...
def test__read_environment_variables():
    assert ErrorStatsServiceClient._read_environment_variables() == (False, "auto", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_CLIENT_CERTIFICATE": "true"}):
        assert ErrorStatsServiceClient._read_environment_variables() == (True, "auto", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "never"}):
        assert ErrorStatsServiceClient._read_environment_variables() == (False, "never", None)

    with mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "always"}):
        assert ErrorStatsServiceClient._read_environment_variables() == (False, "always", None)
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert ErrorStatsServiceClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert ErrorStatsServiceClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert ErrorStatsServiceClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert ErrorStatsServiceClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert ErrorStatsServiceClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source
...
@mock.patch.object(ErrorStatsServiceAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(ErrorStatsServiceAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = ErrorStatsServiceClient._DEFAULT_UNIVERSE
    default_endpoint = ErrorStatsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = ErrorStatsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert ErrorStatsServiceClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert ErrorStatsServiceClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == ErrorStatsServiceClient.DEFAULT_MTLS_ENDPOINT
    assert ErrorStatsServiceClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert ErrorStatsServiceClient._get_api_endpoint(None, None, default_universe, "always") == ErrorStatsServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    assert ErrorStatsServiceClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert ErrorStatsServiceClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        ErrorStatsServiceClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert ErrorStatsServiceClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert ErrorStatsServiceClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert ErrorStatsServiceClient._get_universe_domain(None, None) == ErrorStatsServiceClient._DEFAULT_UNIVERSE
...
def test_list_group_stats_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        client._transport._wrapped_methods[client._transport.list_group_stats] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_group_stats_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.list_group_stats in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_group_stats] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_events_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = ErrorStatsServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_events in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_events] = mock_rpc
...
def test_list_group_stats_rest_bad_request(request_type=error_stats_service.ListGroupStatsRequest):
    client = ErrorStatsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_group_stats_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ErrorStatsServiceRestInterceptor, "post_list_group_stats_with_metadata") as post_with_metadata, \
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = error_stats_service.ListGroupStatsResponse.to_json(error_stats_service.ListGroupStatsResponse())
        ...
        post_with_metadata.return_value = error_stats_service.ListGroupStatsResponse(), metadata
...
def test_list_events_rest_bad_request(request_type=error_stats_service.ListEventsRequest):
    client = ErrorStatsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ErrorStatsServiceRestInterceptor, "post_list_events_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = error_stats_service.ListEventsResponse.to_json(error_stats_service.ListEventsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = error_stats_service.ListEventsResponse(), metadata
...
def test_delete_events_rest_bad_request(request_type=error_stats_service.DeleteEventsRequest):
    client = ErrorStatsServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_events_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.ErrorStatsServiceRestInterceptor, "post_delete_events_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = error_stats_service.DeleteEventsResponse.to_json(error_stats_service.DeleteEventsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = error_stats_service.DeleteEventsResponse(), metadata
