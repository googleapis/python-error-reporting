...
def test_list_group_stats_rest_required_fields(request_type=error_stats_service.ListGroupStatsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_group_stats._get_unset_required_fields(jsonified_request)
...
def test_list_group_stats_rest_unset_required_fields():
    transport = transports.ErrorStatsServiceRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_list_events_rest_required_fields(request_type=error_stats_service.ListEventsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_events_rest_required_fields(request_type=error_stats_service.DeleteEventsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_events._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
