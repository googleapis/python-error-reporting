...
class ErrorStatsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_delete_events(self, request: error_stats_service.DeleteEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_stats_service.DeleteEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_events_with_metadata(self, response: error_stats_service.DeleteEventsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_stats_service.DeleteEventsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_events
    ...
    def pre_list_events(self, request: error_stats_service.ListEventsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_stats_service.ListEventsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_events_with_metadata(self, response: error_stats_service.ListEventsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_stats_service.ListEventsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_events
    ...
    def pre_list_group_stats(self, request: error_stats_service.ListGroupStatsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_stats_service.ListGroupStatsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_group_stats_with_metadata(self, response: error_stats_service.ListGroupStatsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_stats_service.ListGroupStatsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_group_stats
...
class ErrorStatsServiceRestTransport(_BaseErrorStatsServiceRestTransport):
    ...
    class _DeleteEvents(_BaseErrorStatsServiceRestTransport._BaseDeleteEvents, ErrorStatsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseErrorStatsServiceRestTransport._BaseDeleteEvents._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseErrorStatsServiceRestTransport._BaseDeleteEvents._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ErrorStatsServiceRestTransport._DeleteEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            resp, _ = self._interceptor.post_delete_events_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = error_stats_service.DeleteEventsResponse.to_json(response)
                except:
    ...
    class _ListEvents(_BaseErrorStatsServiceRestTransport._BaseListEvents, ErrorStatsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseErrorStatsServiceRestTransport._BaseListEvents._get_http_options()

            request, metadata = self._interceptor.pre_list_events(request, metadata)
            transcoded_request = _BaseErrorStatsServiceRestTransport._BaseListEvents._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseErrorStatsServiceRestTransport._BaseListEvents._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ErrorStatsServiceRestTransport._ListEvents._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = error_stats_service.ListEventsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _ListGroupStats(_BaseErrorStatsServiceRestTransport._BaseListGroupStats, ErrorStatsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseErrorStatsServiceRestTransport._BaseListGroupStats._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseErrorStatsServiceRestTransport._BaseListGroupStats._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ErrorStatsServiceRestTransport._ListGroupStats._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_group_stats_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = error_stats_service.ListGroupStatsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
