...
class ErrorStatsServiceAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ErrorStatsServiceTransport, Callable[..., ErrorStatsServiceTransport]]] = "grpc_asyncio",
    ...
    async def list_group_stats(self,
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_group_stats]
    ...
    async def delete_events(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.delete_events]
