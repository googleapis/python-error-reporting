...
class ErrorGroupServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_get_group(self, request: error_group_service.GetGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_group_service.GetGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_group_with_metadata(self, response: common.ErrorGroup, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[common.ErrorGroup, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_group
    ...
    def pre_update_group(self, request: error_group_service.UpdateGroupRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[error_group_service.UpdateGroupRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_group_with_metadata(self, response: common.ErrorGroup, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[common.ErrorGroup, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_group
...
class ErrorGroupServiceRestTransport(_BaseErrorGroupServiceRestTransport):
    ...
    class _GetGroup(_BaseErrorGroupServiceRestTransport._BaseGetGroup, ErrorGroupServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseErrorGroupServiceRestTransport._BaseGetGroup._get_http_options()

            request, metadata = self._interceptor.pre_get_group(request, metadata)
            transcoded_request = _BaseErrorGroupServiceRestTransport._BaseGetGroup._get_transcoded_request(http_options, request)

            # Jsonify the query params
            query_params = _BaseErrorGroupServiceRestTransport._BaseGetGroup._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ErrorGroupServiceRestTransport._GetGroup._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateGroup(_BaseErrorGroupServiceRestTransport._BaseUpdateGroup, ErrorGroupServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            http_options = _BaseErrorGroupServiceRestTransport._BaseUpdateGroup._get_http_options()

            request, metadata = self._interceptor.pre_update_group(request, metadata)
            transcoded_request = _BaseErrorGroupServiceRestTransport._BaseUpdateGroup._get_transcoded_request(http_options, request)

            body = _BaseErrorGroupServiceRestTransport._BaseUpdateGroup._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseErrorGroupServiceRestTransport._BaseUpdateGroup._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ErrorGroupServiceRestTransport._UpdateGroup._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
