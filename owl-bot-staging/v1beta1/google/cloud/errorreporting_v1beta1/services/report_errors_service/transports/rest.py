...
class ReportErrorsServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_report_error_event(self, request: report_errors_service.ReportErrorEventRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_errors_service.ReportErrorEventRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_report_error_event_with_metadata(self, response: report_errors_service.ReportErrorEventResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[report_errors_service.ReportErrorEventResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for report_error_event
...
class ReportErrorsServiceRestTransport(_BaseReportErrorsServiceRestTransport):
    ...
    class _ReportErrorEvent(_BaseReportErrorsServiceRestTransport._BaseReportErrorEvent, ReportErrorsServiceRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            transcoded_request = _BaseReportErrorsServiceRestTransport._BaseReportErrorEvent._get_transcoded_request(http_options, request)

            body = _BaseReportErrorsServiceRestTransport._BaseReportErrorEvent._get_request_body_json(transcoded_request)

            # Jsonify the query params
            query_params = _BaseReportErrorsServiceRestTransport._BaseReportErrorEvent._get_query_params_json(transcoded_request)
            ...
            # Send the request
            response = ReportErrorsServiceRestTransport._ReportErrorEvent._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
            ...
            resp, _ = self._interceptor.post_report_error_event_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = report_errors_service.ReportErrorEventResponse.to_json(response)
                except:
