...
# source: google/cloud/devtools/clouderrorreporting_v1beta1/proto/error_stats_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="google/cloud/devtools/clouderrorreporting_v1beta1/proto/error_stats_service.proto",
...
_ERRORGROUPSTATS.fields_by_name[
    ...
    google_dot_cloud_dot_devtools_dot_clouderrorreporting__v1beta1_dot_proto_dot_common__pb2._ERRORGROUP
)
...
_ERRORGROUPSTATS.fields_by_name[
    ...
    google_dot_cloud_dot_devtools_dot_clouderrorreporting__v1beta1_dot_proto_dot_common__pb2._ERROREVENT
)
...
ListGroupStatsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      time_range:
          ...
          default time range is used. The field time_range_begin in the
          response will specify the beginning of this time range. Only
          ErrorGroupStats with a non-zero count in the given time range
          are returned, unless the request contains an explicit group_id
          list. If a group_id list is given, also ErrorGroupStats with
...
ListEventsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      time_range:
          ...
          a default time range is used. The field time_range_begin in
